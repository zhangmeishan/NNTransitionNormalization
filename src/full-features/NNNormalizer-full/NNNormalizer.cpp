...
//}
    ...
    dict_tags.push_back("00");
    dict_tags.push_back("01");
    dict_tags.push_back("02"); //informal
    dict_tags.push_back("03");
    dict_tags.push_back("04");
    dict_tags.push_back("05");
    dict_tags.push_back("10");
    dict_tags.push_back("11");
    dict_tags.push_back("12"); //formal
    dict_tags.push_back("13");
    dict_tags.push_back("14");
    dict_tags.push_back("15");
